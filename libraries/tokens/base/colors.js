    ...
    dark: {
      text: {
        ...
        static_icons__secondary: {
          hex: '#ffffff',
          hsla: 'hsla(0, 0%, 100%, 0.87)',
          rgba: 'rgba(255, 255, 255, 0.87)',
        },
        static_icons__tertiary: {
          hex: '#ffffff',
          hsla: 'hsla(0, 0%, 100%, 0.6)',
      ...
      interactive: {
        ...
        primary__hover: {
          hex: '#c0f1fc',
          hsla: 'hsla(191, 90.9%, 87.1%, 1)',
          rgba: 'rgba(192, 241, 252, 1)',
        },
        danger__resting: {
          hex: '#f36666',
        ...
        table__header__fill_hover: {
          hex: '#324d62',
          hsla: 'hsla(206, 32.4%, 29%, 1)',
          rgba: 'rgba(50, 77, 98, 1)',
        },
        ...
        disabled__border: {
          hex: '#4b5b68',
          hsla: 'hsla(207, 16.2%, 35.1%, 1)',
          rgba: 'rgba(75, 91, 104, 1)',
        },
        disabled__fill: {
          hex: '#3e4b56',
          hsla: 'hsla(208, 16.2%, 29%, 1)',
          rgba: 'rgba(62, 75, 86, 1)',
        },
        disabled__text: {
          hex: '#637888',
