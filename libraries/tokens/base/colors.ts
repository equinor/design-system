export const colors = {
  text: {
    ...
    static_icons__primary_white: {
      ...
      hsla: 'hsla(0, 0%, 100%, 1)',
      rgba:
        'var(--eds_text__static_icons__primary_white, rgba(255, 255, 255, 1))',
    },
  },
  ui: {
    background__default: {
    ...
    background__semitransparent: {
      ...
      rgba:
        'var(--eds_ui_background__semitransparent, rgba(255, 255, 255, 0.2))',
    },
    background__light: {
      hex: '#f7f7f7',
  ...
  infographic: {
    substitute__purple_berry: {
      ...
      rgba:
        'var(--eds_infographic_substitute__purple_berry, rgba(140, 17, 89, 1))',
    },
    substitute__pink_rose: {
      hex: '#e24973',
      hsla: 'hsla(344, 72.5%, 58.6%, 1)',
      rgba:
        'var(--eds_infographic_substitute__pink_rose, rgba(226, 73, 115, 1))',
    },
    substitute__pink_salmon: {
      hex: '#ff92a8',
      hsla: 'hsla(348, 100%, 78.6%, 1)',
      rgba:
        'var(--eds_infographic_substitute__pink_salmon, rgba(255, 146, 168, 1))',
    },
    substitute__green_cucumber: {
      hex: '#005f57',
      hsla: 'hsla(175, 100%, 18.6%, 1)',
      rgba:
        'var(--eds_infographic_substitute__green_cucumber, rgba(0, 95, 87, 1))',
    },
    substitute__green_succulent: {
      hex: '#00977b',
      hsla: 'hsla(169, 100%, 29.6%, 1)',
      rgba:
        'var(--eds_infographic_substitute__green_succulent, rgba(0, 151, 123, 1))',
    },
    substitute__green_mint: {
      hex: '#40d38f',
      hsla: 'hsla(152, 62.6%, 53.9%, 1)',
      rgba:
        'var(--eds_infographic_substitute__green_mint, rgba(64, 211, 143, 1))',
    },
    substitute__blue_ocean: {
      hex: '#004088',
      hsla: 'hsla(212, 100%, 26.7%, 1)',
      rgba:
        'var(--eds_infographic_substitute__blue_ocean, rgba(0, 64, 136, 1))',
    },
    substitute__blue_overcast: {
      hex: '#0084c4',
      hsla: 'hsla(200, 100%, 38.4%, 1)',
      rgba:
        'var(--eds_infographic_substitute__blue_overcast, rgba(0, 132, 196, 1))',
    },
    substitute__blue_sky: {
      hex: '#52c0ff',
      hsla: 'hsla(202, 100%, 66.1%, 1)',
      rgba:
        'var(--eds_infographic_substitute__blue_sky, rgba(82, 192, 255, 1))',
    },
    primary__moss_green_100: {
      hex: '#007079',
      hsla: 'hsla(184, 100%, 23.7%, 1)',
      rgba:
        'var(--eds_infographic_primary__moss_green_100, rgba(0, 112, 121, 1))',
    },
    primary__moss_green_55: {
      hex: '#73b1b5',
      hsla: 'hsla(184, 30.8%, 58%, 1)',
      rgba:
        'var(--eds_infographic_primary__moss_green_55, rgba(115, 177, 181, 1))',
    },
    primary__moss_green_34: {
      hex: '#a8ced1',
      hsla: 'hsla(184, 30.8%, 73.9%, 1)',
      rgba:
        'var(--eds_infographic_primary__moss_green_34, rgba(168, 206, 209, 1))',
    },
    primary__moss_green_21: {
      hex: '#c9e0e2',
      hsla: 'hsla(185, 30.1%, 83.7%, 1)',
      rgba:
        'var(--eds_infographic_primary__moss_green_21, rgba(201, 224, 226, 1))',
    },
    primary__moss_green_13: {
      hex: '#deedee',
      hsla: 'hsla(184, 32%, 90.2%, 1)',
      rgba:
        'var(--eds_infographic_primary__moss_green_13, rgba(222, 237, 238, 1))',
    },
    primary__energy_red_100: {
      hex: '#eb0037',
      hsla: 'hsla(346, 100%, 46.1%, 1)',
      rgba:
        'var(--eds_infographic_primary__energy_red_100, rgba(235, 0, 55, 1))',
    },
    primary__energy_red_55: {
      hex: '#ff7d98',
      hsla: 'hsla(348, 100%, 74.5%, 1)',
      rgba:
        'var(--eds_infographic_primary__energy_red_55, rgba(255, 125, 152, 1))',
    },
    primary__energy_red_34: {
      hex: '#ffaebf',
      hsla: 'hsla(347, 100%, 84.1%, 1)',
      rgba:
        'var(--eds_infographic_primary__energy_red_34, rgba(255, 174, 191, 1))',
    },
    primary__energy_red_21: {
      hex: '#ffcdd7',
      hsla: 'hsla(348, 100%, 90.2%, 1)',
      rgba:
        'var(--eds_infographic_primary__energy_red_21, rgba(255, 205, 215, 1))',
    },
    primary__energy_red_13: {
      hex: '#ffe0e7',
      hsla: 'hsla(346, 100%, 93.9%, 1)',
      rgba:
        'var(--eds_infographic_primary__energy_red_13, rgba(255, 224, 231, 1))',
    },
    primary__weathered_red: {
      hex: '#7d0023',
      hsla: 'hsla(343, 100%, 24.5%, 1)',
      rgba:
        'var(--eds_infographic_primary__weathered_red, rgba(125, 0, 35, 1))',
    },
    primary__slate_blue: {
      hex: '#243746',
    ...
    primary__spruce_wood: {
      ...
      hsla: 'hsla(25, 100%, 92%, 1)',
      rgba:
        'var(--eds_infographic_primary__spruce_wood, rgba(255, 231, 214, 1))',
    },
    primary__mist_blue: {
      hex: '#d5eaf4',
      hsla: 'hsla(199, 58.5%, 89.6%, 1)',
    ...
    primary__lichen_green: {
      ...
      rgba:
        'var(--eds_infographic_primary__lichen_green, rgba(230, 250, 236, 1))',
    },
  },
  logo: {
    fill_positive: {
  ...
  interactive: {
    primary__selected_highlight: {
      ...
      hsla: 'hsla(138, 66.7%, 94.1%, 1)',
      rgba:
        'var(--eds_interactive_primary__selected_highlight, rgba(230, 250, 236, 1))',
    },
    primary__selected_hover: {
      hex: '#c3f3d2',
      hsla: 'hsla(139, 66.7%, 85.9%, 1)',
      rgba:
        'var(--eds_interactive_primary__selected_hover, rgba(195, 243, 210, 1))',
    },
    primary__resting: {
      hex: '#007079',
      hsla: 'hsla(184, 100%, 23.7%, 1)',
    ...
    secondary__highlight: {
      ...
      hsla: 'hsla(199, 58.5%, 89.6%, 1)',
      rgba:
        'var(--eds_interactive_secondary__highlight, rgba(213, 234, 244, 1))',
    },
    secondary__resting: {
      hex: '#243746',
      hsla: 'hsla(206, 32.1%, 20.8%, 1)',
    ...
    table__cell__fill_resting: {
      ...
      hsla: 'hsla(0, 0%, 100%, 1)',
      rgba:
        'var(--eds_interactive_table__cell__fill_resting, rgba(255, 255, 255, 1))',
    },
    table__cell__fill_hover: {
      hex: '#eaeaea',
      hsla: 'hsla(0, 0%, 91.8%, 1)',
      rgba:
        'var(--eds_interactive_table__cell__fill_hover, rgba(234, 234, 234, 1))',
    },
    table__cell__fill_activated: {
      hex: '#e6faec',
      hsla: 'hsla(138, 66.7%, 94.1%, 1)',
      rgba:
        'var(--eds_interactive_table__cell__fill_activated, rgba(230, 250, 236, 1))',
    },
    table__header__fill_activated: {
      hex: '#eaeaea',
      hsla: 'hsla(0, 0%, 91.8%, 1)',
      rgba:
        'var(--eds_interactive_table__header__fill_activated, rgba(234, 234, 234, 1))',
    },
    table__header__fill_hover: {
      hex: '#dcdcdc',
      hsla: 'hsla(0, 0%, 86.3%, 1)',
      rgba:
        'var(--eds_interactive_table__header__fill_hover, rgba(220, 220, 220, 1))',
    },
    table__header__fill_resting: {
      hex: '#f7f7f7',
      hsla: 'hsla(0, 0%, 96.9%, 1)',
      rgba:
        'var(--eds_interactive_table__header__fill_resting, rgba(247, 247, 247, 1))',
    },
    disabled__text: {
      hex: '#bebebe',
    ...
    link_on_interactive_colors: {
      ...
      hsla: 'hsla(0, 0%, 100%, 1)',
      rgba:
        'var(--eds_interactive__link_on_interactive_colors, rgba(255, 255, 255, 1))',
    },
    icon_on_interactive_colors: {
      hex: '#ffffff',
      hsla: 'hsla(0, 0%, 100%, 1)',
      rgba:
        'var(--eds_interactive__icon_on_interactive_colors, rgba(255, 255, 255, 1))',
    },
    link_in_snackbars: {
      hex: '#97cace',
    ...
    pressed_overlay_light: {
      ...
      hsla: 'hsla(0, 0%, 100%, 0.2)',
      rgba:
        'var(--eds_interactive__pressed_overlay_light, rgba(255, 255, 255, 0.2))',
    },
  },
}
