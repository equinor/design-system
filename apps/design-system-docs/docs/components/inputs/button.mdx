...
import MobileButton from '../../mobile/components/inputs/button.mdx';
...
![Button preview](https://raw.githubusercontent.com/equinor/design-system-mobile/main/docs/assets/button-preview.gif)
...
![Button variants](https://raw.githubusercontent.com/equinor/design-system-mobile/main/docs/assets/button-variants.gif)
...
![Button tones](https://raw.githubusercontent.com/equinor/design-system-mobile/main/docs/assets/button-tones.gif)
...
![Icon-only buttons](https://raw.githubusercontent.com/equinor/design-system-mobile/main/docs/assets/button-icon-only.gif)
...
![Circular icon-only buttons](https://raw.githubusercontent.com/equinor/design-system-mobile/main/docs/assets/button-circular.gif)
...
For full API documentation and interactive examples, see the [Button Storybook](https://storybook.eds.equinor.com/?path=/story/eds-2-0-beta-inputs-button--default).

</TabItem>
<TabItem value="mobile" label="Mobile">

{/* Content pulled from equinor/design-system-mobile via docusaurus-plugin-remote-content */}
<MobileButton />
