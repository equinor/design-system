...
description: The primitive scale under the named steps and how each density maps onto it.
---
...
- [Using spacing](./spacing-usage.mdx): guidance and examples for choosing a spacing step.
- [Token reference](./spacing-reference.mdx): every token and value in all three densities.
