...
**18 tokens.** Each one has three values, one per density. The **Token**
...
14 steps, applied to `padding`, `gap` and `margin`.
...
| `spacing.4xl` † | `--eds-spacing-4xl` | 44px | 48px | 52px |
| `spacing.5xl` † | `--eds-spacing-5xl` | 88px | 96px | 112px |
| `spacing.6xl` † | `--eds-spacing-6xl` | 112px | 128px | 144px |
