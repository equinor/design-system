...
For detailed photography guidelines and access to approved images, please refer to the [Equinor resources](/docs/Next/resources#external-references). You can download Equinor photos from the [Media Bank](https://equinor.fotoware.cloud/fotoweb/) (internal Equinor site).
