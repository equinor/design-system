  ...
  scenes: [
    ...
    },
    {
      ...
      lines: [
        ...
        'The mill cuts md to spec: the base, times two-to-the-minus-one-fifth. At the default base, that lands on 14 pixels — sizes round to a half-pixel grid, so plenty come out fractional, like xs at 10.5.',
