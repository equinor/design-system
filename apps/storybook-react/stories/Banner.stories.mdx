...
<Meta title="MDX/Banner" component={Banner} subcomponents={{BannerMessage: Banner.BannerMessage, BannerIcon: Banner.BannerIcon, BannerActions: Banner.BannerActions}} />
