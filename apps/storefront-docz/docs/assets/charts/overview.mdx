...
5. Once the chart looks correct, click **Add chart** at the bottom of the pop-up.
6. This will place the chart on the centre of the page. Move the chart to the frame/artboard where it is needed.
