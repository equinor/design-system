---
title: System icons
metaTitle: System icons contribution
tabs:
  - Overview
  - Library
  - Usage
...
toc:
  ...
  - Categories
mode: publish
route: /assets/system-icons/contribution/
---
...
- :warning: More information to come about submitting process. In the mean-time reach out to one of the EDS core members on Slack.
