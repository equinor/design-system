...
There is not limit to the amount of projects a team can have---this is great, because your team can then stay very organised. Each file created, inside a project, must contain a cover page. A cover page sits on the first page of every file, the page name should be "Cover". Place the `Default File Cover` on the page and file in the information. This allows others now or much later down the road to know who is responsible for this file and who to ask if they have questions. Change the status badge as the file progresses, remembering to change the background color of the cover page to match the current badge color.  

<Embed url="https://www.figma.com/file/0TbIXrrObWj80Cf7KucKYFL0/Design-Tokens?node-id=339%3A2840" />


### Working clean

Use the pages on the left side of Figma to create organisation. There is not limit to the amount of pages you can create in Figma. Break apart main sections of your app, if necessary. Create a page for custom components to that project, if needed. Also, consider making a page for sketches and mess. Everything on pages that your team members will be using should be clean and organised. 


#### Laying out your frames/artboards
