...
There is not limit to the amount of projects a team can have, which is great since this will help your team stay very organised. Each file created, inside a project, must contain a cover page. A cover page sits on the first page of every file, and the page name should be *Cover*. Place the `Default File Cover` on the page and fill in the information. This allows others now, or much later down the road, to know who is responsible for this file and who to ask if they have questions. Change the status badge as the file progresses, remembering to change the background colour of the cover page to match the current badge colour.  
