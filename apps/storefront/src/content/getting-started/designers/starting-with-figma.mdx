...
* You will have two tabs in your Figma account. The way to know the tabs apart is the Equinor tab will say "Equinor" and have the logo, while your personal tab will have your name and your initials. The first tab is your Equinor area, which is for projects shared with everyone. One thing to note, is that you can not transfer projects or files from your personal area to the Equinor area. The second tab is your personal area, which is 100% your area to play around in Figma for free and test things out in private. If your account is deactivated, all your Equinor tab drafts will be transferred to the Equinor Figma admins---so this area should only be used for work files. 
...
Search first to make sure the team doesn't already exist. Projects should not be mixed, so make a team per project. There is no limit in Figma for the amount of teams created---however, there is no need for duplicates. To create a team, click the "Create New Team" button that is at the end of the teams lists pop-up. Give the team an appropriate name, knowing that anyone in Figma can see the name. You will also need to choose "Access within the organisation". 
