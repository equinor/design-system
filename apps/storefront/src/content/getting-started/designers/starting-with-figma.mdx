...
* Go to [AccessIT](https://accessit.equinor.com "AccessIT"), search and apply for Figma access.
* A yearly cost is shown, but this cost is only activated if you are given *editor* access from your Figma team *admin*. 
...
* When you get the email saying it was approved, read through all the instructions. 


## Logging into Figma

* Go to Figma and select **Log in**. Then select **Log in with SAML SSO**, enter your Equinor email and **Log in**.
* You will have two tabs in your Figma account. The way to know the tabs apart is the Equinor will say **Equinor** with the logo, while your personal tab will have your name and initials.
  * The first tab is your Equinor area, which is for projects shared with everyone. One thing to note, is that you can not transfer projects or files from your personal area to the Equinor area. If your account is deactivated, all your Equinor tab drafts will be transferred to the Equinor Figma *admins*---so this area should only be used for work files.
  * The second tab is your personal area, which is 100% your area to play around in Figma for free and test things out in private.  
