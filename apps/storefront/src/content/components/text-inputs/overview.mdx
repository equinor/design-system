...
An error or warning must always have helper text with an icon or an icon in the field. Wait to validate until the user has finished interacting with the field. 
