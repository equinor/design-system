...
Banners should have a single message with (optional) specific actions related to that message. Banner messages should be written as full sentences with punctuation. 
