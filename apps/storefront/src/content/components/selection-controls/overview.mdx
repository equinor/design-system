...
Selection controls are to be visible and understandable at a quick glance. Selected options are more viable than unselected. Selection controls are always accompanied with a clear label. 
...
Switches allow users to toggle a single item between two possible states, taking immediate action. The most common states for a switch is "on/off".
...
* Never use a radio button without one item being selected by default. 
