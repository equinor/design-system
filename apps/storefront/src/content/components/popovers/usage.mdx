...
4. If using text, edit the text. If the text wraps over one line, add 16px in height per line of text added to the whole component.
5. If using the placeholder, replace the placeholder with your custom content. 
