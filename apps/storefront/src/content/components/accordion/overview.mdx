...
* Do not hide errors or critical information requiring immediate action inside an accordion. 
...
Labels should provide clear and concise direction. Avoid labels that are too long. Labels should be to the point and short and no more than three words. Note that if the label is longer than the maximum width, it will be truncated and should have a tooltip provided. 
