...
3. Under the **Constraints** section, set up the following constraints:   
    * Check of the box called **Fix position when scrolling**.
    * Set the constraints to **Left & Right** and **Top**.
4. Edit the content sections: 
    * Title and navigation: Tripple-click on the title to edit. Edit the icon button to have the needed icon. 
    * Custom content: Build your own components to swap the nested `Placeholder` instance with if needed. 
