...
<FigmaImage url="https://www.figma.com/file/0bGXR2sCwMVSDNyyzu5BXrO5/Desktop-UI?node-id=660%3A5150" />
...
The center block of the topbar can either be left empty, or custom content can be inserted into the placeholder. 
...
The actions on the far left are standard. This area is for the following common actions within the application: 
