...
Tabs have a minimum width - which is `Spacer/16 - Medium` on each side of the label. Tabs have a maximum width of 360px. 

Tab width can be decided by 3 factors.
...
3. Each tab having it's own minimum width, to conserve space. 
