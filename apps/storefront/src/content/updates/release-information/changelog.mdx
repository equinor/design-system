...
* Removed background from the [Text fields/Input and Area/Read only](https://www.figma.com/file/0bGXR2sCwMVSDNyyzu5BXrO5/UI%E2%80%94User-Interface?node-id=1%3A26) component to distinguish it from the Disabled state.

<Image url="images/2020/20200318-text%20fields%20read%20only%201600px.jpg" alt="Picture showing Text fields/Input/Read only before and after changes" />
