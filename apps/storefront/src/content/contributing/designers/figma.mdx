...
* Make sure the section is grouped together on an frame and that all the components are the top layers. Extend the frame height when adding a new components. 
