...
When refering to a component group name, use *italics* the first time the grouing is referenced. Following refernces, on the same page, do not need special formatting. 
