...
Clear, accurate and concise language allows for a better user-experience of the EDS. Keep in mind that the EDS will be read by many who's first language is not English. Use words and sentences that are easy to understand and short as possible. Consistency is important, so use existing EDS documentation as an example when writing new documentation. 
