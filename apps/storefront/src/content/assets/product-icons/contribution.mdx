...
Each icon needs to be reduced to its minimal form---being bold, geometrical and symmetrical. To reflect the rounded corners of the logo, icons need to have rounded corners of 1px. To reflect the brand, icons use a consistent stroke of 1px---this inculdes curves, angles and both interior and exterior strokes. 
...
* Create an artboard that is 48x48px. 
  * Place the `.Product icon grid` from the **Utilites** page from **Assets File** as the bottom layer and lock the layer.
