...
- Always make sure to follow the [accessibility guidelines](https://eds.equinor.com/guidelines/accessibility/ "EDS accessibility guidelines") by having 8px of spacing between each clickbound. 
