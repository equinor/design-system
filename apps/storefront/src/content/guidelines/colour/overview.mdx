...
Energy Red is strategically not used for components in EDS since it is easy to misunderstand as an error or alert colour. Please refer to the Equinor [Brand Center](https://communicationtoolbox.equinor.com/brandcenter/en/equinorbc/component/default/98 "Brand Center Toolbox Guidelines") for guidelines on usage of Energy Red, for instance in infographics, brand illustrations or other brand/communication products.
