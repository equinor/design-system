...
There are six elevations effects to choose between: `None`, `Raised`, `Overlay`, `Sticky`, `Temporary nav` and `Above scrim`. 

<Embed url="https://www.figma.com/file/0TbIXrrObWj80Cf7KucKYFL0/Design-Tokens?node-id=239%3A2" />
