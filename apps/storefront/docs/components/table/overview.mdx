...
<Playground>
  <Table>
    <Table.Caption>
      <Typography variant="h3">Fruits cost price</Typography>
    </Table.Caption>
    <Table.Head>
      <Table.Row>
        ...
        <Table.Cell scope="col">
        Price 
        <Typography group="input" as="span" variant="label" color="currentColor">
          ($)
        </Typography>
        </Table.Cell>
      </Table.Row>
    ...
    <Table.Body>
      <Table.Row>
        <Table.Cell variant="numeric">123-456</Table.Cell>
        <Table.Cell>Pears</Table.Cell>
        <Table.Cell>Europe</Table.Cell>
        <Table.Cell variant="numeric">1.5</Table.Cell>
      </Table.Row>
      <Table.Row>
        <Table.Cell variant="numeric">234-567</Table.Cell>
        <Table.Cell>Apples</Table.Cell>
        <Table.Cell>Africa</Table.Cell>
        <Table.Cell variant="numeric">1.2</Table.Cell>
      </Table.Row>
    </Table.Body>
  </Table>

   <Table density="compact" style={{marginTop: '2rem'}}>
    <Table.Caption>
      <Typography variant="h3">Fruits cost price (compact mode)</Typography>
    </Table.Caption>
    <Table.Head>
      <Table.Row>
        <Table.Cell scope="col">
        ...
        <Table.Cell scope="col">
        Price 
        <Typography group="input" variant="label" as="span" color="currentColor">
          ($)
        </Typography>
        </Table.Cell>
      </Table.Row>
