...
6. If you have multiple lines text in a cell, adjust the height with 20 pixels per additional lines. [See example in Figma](https://www.figma.com/file/luNobpDIWTuQ9rhyovGLBI/Desktop?node-id=2365%3A57007)

7. Adjust the width of the header to fit the column width of the cells below, where the minimum width is defined by the right spacing.
