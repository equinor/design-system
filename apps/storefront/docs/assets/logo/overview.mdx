...
<FigmaImage
  url="https://www.figma.com/file/BQjYMxdSdgRkdhKTDDU7L4KU/Assets?node-id=71%3A107"
  alt="Figma design for main logo"
/>
...
<FigmaImage
  url="https://www.figma.com/file/BQjYMxdSdgRkdhKTDDU7L4KU/Assets?node-id=71%3A141"
  alt="Figma design for star symbol"
/>
...
<FigmaImage
  url="https://www.figma.com/file/BQjYMxdSdgRkdhKTDDU7L4KU/Assets?node-id=71%3A172"
  alt="Figma design for fav icon"
/>

## External use

Please visit the Equinor [Brand Center](https://communicationtoolbox.equinor.com/brandcenter/en/equinorbc/component/default/97 'Brand Center Toolbox Guidelines') for more information about using the Equinor logo.
