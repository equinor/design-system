...
- `Grid/Small`
 ...
 Visit [grid alignment](https://eds.equinor.com/patterns/grid-alignment/) for more details on on how to use the grid together with components.  
