...
```sh
npm install @equinor/eds-core-react/dist/core-react.cjs.js styled-components
```

### Usage

```jsx
const { Button } = '@equinor/eds-core-react/dist/core-react.cjs.js'
...
The following example uses the `<Icon>` component from `@equinor/eds-core-react/dist/core-react.cjs.js` – but the icons package can also be used without React.
...
```jsx
import { Icon } from '@equinor/eds-core-react/dist/core-react.cjs.js'
