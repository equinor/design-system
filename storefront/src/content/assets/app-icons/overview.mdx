...
Simple and clear icons require a strict underlying gird. The EDS icons are built on a 48 x 48 pixel grid. Product icons can scale up - but not down - depending on context in the grid shape.
