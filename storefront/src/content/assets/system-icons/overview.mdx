...
The EDS icons are always faceing forward and never rotaties or dimensional. The icons are made for legebility and are not too literal or complex, neither are they overly playfull or bubbly. 


### Missing icons

If you need additional icons, it is possible to create your own icons and sumbit them via contribution to the EDS. (:warning: Need contribution link)
