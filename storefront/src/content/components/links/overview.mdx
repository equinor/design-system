...
**Links are primarily used as navigational elements though they can also change how data is viewed**
...
Links can be used on their own, in body text, ordered lists, unordered lists
