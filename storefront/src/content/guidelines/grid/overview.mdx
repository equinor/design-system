...
It is the responsibility of the designers to define a max width and choose the correct grid. 
It is the responsibility of the developers to implement the max width and use the grid as designed. 
