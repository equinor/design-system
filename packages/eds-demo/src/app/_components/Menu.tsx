...
const MenuItem = ({
  ...
  return (
    <div
      ...
      className={`box-border content-stretch flex flex-col items-start relative shrink-0 w-full ${active ? activeClassName : className}`}
    >
...
export const Menu = ({
  ...
  return (
    <div
      ...
      className={`${className} box-border px-0 rounded-[4px] shadow-[0px_12px_17px_0px_rgba(0,0,0,0.14),0px_5px_22px_0px_rgba(0,0,0,0.12),0px_7px_8px_0px_rgba(0,0,0,0.2)] m-0 min-w-[120px] [&:popover-open]:flex [&:popover-open]:flex-col [&:popover-open]:items-start`}
      style={
        {
