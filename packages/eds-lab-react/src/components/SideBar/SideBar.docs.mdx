...
We do not provide logic for detecting current path, as different projects and third party routers 
have different needs and behaviours around this, and may have their own tools or hooks to simplify this.
