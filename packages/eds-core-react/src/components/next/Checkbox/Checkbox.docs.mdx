...
<Links
  ...
  sourceUrl="https://github.com/equinor/design-system/blob/main/packages/eds-core-react/src/components/next/Checkbox/Checkbox.tsx"
...
<Canvas of={ComponentStories.InheritedDisabled} />
