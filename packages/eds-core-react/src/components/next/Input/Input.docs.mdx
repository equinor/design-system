...
> **Note:** This is a [EDS 2.0 (beta) component](/docs/eds-2-0-beta-about--docs). See the introduction guide for information about installation, usage, and the EDS 2.0 token system.
