...
to make the component un-controlled.
<Story id="navigation-sidebar--with-accordion" />

### With routing

How the SideBar can be used for navigation, including all components available to use.
We are using state to decide which page to display. In the real world you would likely use a router.
<Story id="navigation-sidebar--with-routing" />
...
<Story id="navigation-sidebar--controlled-example" />
