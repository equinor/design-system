...
<Story id="inputs-buttons-button--introduction" />
<PropsTable />
...
<Story id="inputs-buttons-button--basic" />
...
<Story id="inputs-buttons-button--icon-button" />

### Color

<Story id="inputs-buttons-button--color"/>
