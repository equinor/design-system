...
See the [TypographyNext documentation](/docs/typography-typographynext--docs) and [Migration Guide](https://github.com/equinor/design-system/blob/develop/packages/eds-core-react/src/components/Typography/MIGRATION_GUIDE.md) for details.
